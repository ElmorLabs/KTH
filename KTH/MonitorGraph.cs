    ...
    public partial class MonitorGraph : UserControl {
        ...
        private void panel1_Paint(object sender, PaintEventArgs e) {
            ...
            if(x > 0 && x < values.Count) {
                ...
                g.DrawString(String.Format("{0,10}", $"{values[x].ToString("F" + round.ToString())} {unit}"), drawFont, markBrush, new Point(this.Size.Width - 75, 0));
            } else {
                ...
                g.DrawString(String.Format("{0,10}", latestVal), drawFont, drawBrush, new Point(this.Size.Width - 75, 0));
            }
        }
        ...
        public void addValue(double val) {
            ...
            latestVal = $"{val.ToString("F" + round.ToString())} {unit}";
